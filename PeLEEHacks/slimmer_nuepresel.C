...
void slimmer_nuepresel(TString fname)
{
   ...
   TString dirorigin = "/pnfs/uboone/persistent/users/davidc/searchingfornues/v08_00_00_43/0928/";
   TString dir = "/uboone/data/users/davidc/searchingfornues/v08_00_00_48/0928/run1/";
   TString fullpath = dirorigin + fname; // + ".root";
   TString foutname = dir + "/nuepresel/" + fname; // + ".root";
