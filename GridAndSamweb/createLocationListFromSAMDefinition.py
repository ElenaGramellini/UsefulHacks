...
parser.add_argument("definitionName"   , nargs='?', default = 'MCC8.20-CCpi0_bnb', type = str, help="insert fileName")
...
command = "samweb -e uboone list-definition-files "+ definitionName
...
fileListName = definitionName + "_FileNames.list"

fileHandler = open (fileListName, "w")
fileHandler.write( dimensions )
fileHandler.close()
